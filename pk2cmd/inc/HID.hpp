...
#pragma pack(pop)
    ...
    typedef BOOL __stdcall (*THidD_SetConfiguration)(unsigned HidDeviceObject, const HIDD_CONFIGURATION &HidConfig,
                                                     int Size);
    ...
    typedef BOOL __stdcall (*THidD_GetIndexedString)(unsigned HidDeviceObject, int Index, wchar_t *Buffer,
                                                     int BufferLength);

    typedef int __stdcall (*THidP_GetCaps)(void *PreparsedData, HIDP_CAPS &Capabilities);

    typedef int __stdcall (*THidP_GetLinkCollectionNodes)(PHIDPLinkCollectionNode LinkCollectionNodes,
                                                          unsigned &LinkCollectionNodesLength, void *PreparsedData);

    typedef int __stdcall (*THidP_GetSpecificButtonCaps)(unsigned ReportType, Word UsagePage, Word LinkCollection,
                                                         Word Usage, PHIDPButtonCaps ButtonCaps, Word &ButtonCapsLength,
                                                         void *PreparsedData);

    typedef int __stdcall (*THidP_GetSpecificValueCaps)(unsigned ReportType, Word UsagePage, Word LinkCollection,
                                                        Word Usage, PHIDPValueCaps ValueCaps, Word &ValueCapsLength,
                                                        void *PreparsedData);

    typedef int __stdcall (*THidP_GetData)(unsigned ReportType, PHIDPData DataList, unsigned &DataLength,
                                           void *PreparsedData, void *Report, unsigned ReportLength);

    typedef int __stdcall (*THidP_SetData)(unsigned ReportType, PHIDPData DataList, unsigned &DataLength,
                                           void *PreparsedData, void *Report, unsigned ReportLength);

    typedef unsigned __stdcall (*THidP_MaxDataListLength)(unsigned ReportType, void *PreparsedData);

    typedef int __stdcall (*THidP_GetUsages)(unsigned ReportType, Word UsagePage, Word LinkCollection, PUsage UsageList,
                                             unsigned &UsageLength, void *PreparsedData, void *Report,
                                             unsigned ReportLength);

    typedef int __stdcall (*THidP_GetButtons)(unsigned ReportType, Word UsagePage, Word LinkCollection,
                                              PUsage UsageList, unsigned &UsageLength, void *PreparsedData,
                                              void *Report, unsigned ReportLength);

    typedef int __stdcall (*THidP_GetUsagesEx)(unsigned ReportType, Word LinkCollection, PUsageAndPage UsageList,
                                               unsigned &UsageLength, void *PreparsedData, void *Report,
                                               unsigned ReportLength);

    typedef int __stdcall (*THidP_GetButtonsEx)(unsigned ReportType, Word LinkCollection, PUsageAndPage UsageList,
                                                unsigned &UsageLength, void *PreparsedData, void *Report,
                                                unsigned ReportLength);

    typedef int __stdcall (*THidP_SetUsages)(unsigned ReportType, Word UsagePage, Word LinkCollection, PUsage UsageList,
                                             unsigned &UsageLength, void *PreparsedData, void *Report,
                                             unsigned ReportLength);

    typedef int __stdcall (*THidP_SetButtons)(unsigned ReportType, Word UsagePage, Word LinkCollection,
                                              PUsage ButtonList, unsigned &ButtonLength, void *PreparsedData,
                                              void *Report, unsigned ReportLength);

    typedef int __stdcall (*THidP_UnsetUsages)(unsigned ReportType, Word UsagePage, Word LinkCollection,
                                               PUsage UsageList, unsigned &UsageLength, void *PreparsedData,
                                               void *Report, unsigned ReportLength);

    typedef int __stdcall (*THidP_UnsetButtons)(unsigned ReportType, Word UsagePage, Word LinkCollection,
                                                PUsage ButtonList, unsigned &ButtonLength, void *PreparsedData,
                                                void *Report, unsigned ReportLength);
    ...
    typedef int __stdcall (*THidP_GetUsageValue)(unsigned ReportType, Word UsagePage, Word LinkCollection, Word Usage,
                                                 unsigned &UsageValue, void *PreparsedData, void *Report,
                                                 unsigned ReportLength);

    typedef int __stdcall (*THidP_GetScaledUsageValue)(unsigned ReportType, Word UsagePage, Word LinkCollection,
                                                       Word Usage, int &UsageValue, void *PreparsedData, void *Report,
                                                       unsigned ReportLength);

    typedef int __stdcall (*THidP_GetUsageValueArray)(unsigned ReportType, Word UsagePage, Word LinkCollection,
                                                      Word Usage, char *UsageValue, Word UsageValueByteLength,
                                                      void *PreparsedData, void *Report, unsigned ReportLength);

    typedef int __stdcall (*THidP_SetUsageValue)(unsigned ReportType, Word UsagePage, Word LinkCollection, Word Usage,
                                                 unsigned UsageValue, void *PreparsedData, void *Report,
                                                 unsigned ReportLength);

    typedef int __stdcall (*THidP_SetScaledUsageValue)(unsigned ReportType, Word UsagePage, Word LinkCollection,
                                                       Word Usage, int UsageValue, void *PreparsedData, void *Report,
                                                       unsigned ReportLength);

    typedef int __stdcall (*THidP_SetUsageValueArray)(unsigned ReportType, Word UsagePage, Word LinkCollection,
                                                      Word Usage, char *UsageValue, Word UsageValueByteLength,
                                                      void *PreparsedData, void *Report, unsigned ReportLength);

    typedef int __stdcall (*THidP_UsageListDifference)(PUsage PreviousUsageList, PUsage CurrentUsageList,
                                                       PUsage BreakUsageList, PUsage MakeUsageList,
                                                       unsigned UsageListLength);

    typedef int __stdcall (*THidP_TranslateUsagesToI8042ScanCodes)(PUsage ChangedUsageList, unsigned UsageListLength,
                                                                   unsigned KeyAction, unsigned &ModifierState,
                                                                   THIDPInsertScanCodes InsertCodesProcedure,
                                                                   void *InsertCodesContext);
...
//-- var, const, procedure ---------------------------------------------------
    ...
    extern PACKAGE THidD_Hello
    HidD_Hello;
    extern PACKAGE THidD_GetHidGuid
    HidD_GetHidGuid;
    extern PACKAGE THidD_GetPreparsedData
    HidD_GetPreparsedData;
    extern PACKAGE THidD_FreePreparsedData
    HidD_FreePreparsedData;
    extern PACKAGE THidD_GetConfiguration
    HidD_GetConfiguration;
    extern PACKAGE THidD_SetConfiguration
    HidD_SetConfiguration;
    extern PACKAGE THidD_FlushQueue
    HidD_FlushQueue;
    extern PACKAGE THidD_GetFeature
    HidD_GetFeature;
    extern PACKAGE THidD_SetFeature
    HidD_SetFeature;
    extern PACKAGE THidD_GetNumInputBuffers
    HidD_GetNumInputBuffers;
    extern PACKAGE THidD_SetNumInputBuffers
    HidD_SetNumInputBuffers;
    extern PACKAGE THidD_GetAttributes
    HidD_GetAttributes;
    extern PACKAGE THidD_GetManufacturerString
    HidD_GetManufacturerString;
    extern PACKAGE THidD_GetProductString
    HidD_GetProductString;
    extern PACKAGE THidD_GetSerialNumberString
    HidD_GetSerialNumberString;
    extern PACKAGE THidD_GetPhysicalDescriptor
    HidD_GetPhysicalDescriptor;
    extern PACKAGE THidD_GetIndexedString
    HidD_GetIndexedString;
    extern PACKAGE THidP_GetCaps
    HidP_GetCaps;
    extern PACKAGE THidP_GetLinkCollectionNodes
    HidP_GetLinkCollectionNodes;
    extern PACKAGE THidP_GetSpecificButtonCaps
    HidP_GetSpecificButtonCaps;
    extern PACKAGE THidP_GetSpecificValueCaps
    HidP_GetSpecificValueCaps;
    extern PACKAGE THidP_GetData
    HidP_GetData;
    extern PACKAGE THidP_SetData
    HidP_SetData;
    extern PACKAGE THidP_MaxDataListLength
    HidP_MaxDataListLength;
    extern PACKAGE THidP_GetUsages
    HidP_GetUsages;
    extern PACKAGE THidP_GetButtons
    HidP_GetButtons;
    extern PACKAGE THidP_GetUsagesEx
    HidP_GetUsagesEx;
    extern PACKAGE THidP_GetButtonsEx
    HidP_GetButtonsEx;
    extern PACKAGE THidP_SetUsages
    HidP_SetUsages;
    extern PACKAGE THidP_SetButtons
    HidP_SetButtons;
    extern PACKAGE THidP_UnsetUsages
    HidP_UnsetUsages;
    extern PACKAGE THidP_UnsetButtons
    HidP_UnsetButtons;
    extern PACKAGE THidP_MaxUsageListLength
    HidP_MaxUsageListLength;
    extern PACKAGE THidP_MaxButtonListLength
    HidP_MaxButtonListLength;
    extern PACKAGE THidP_GetUsageValue
    HidP_GetUsageValue;
    extern PACKAGE THidP_GetScaledUsageValue
    HidP_GetScaledUsageValue;
    extern PACKAGE THidP_GetUsageValueArray
    HidP_GetUsageValueArray;
    extern PACKAGE THidP_SetUsageValue
    HidP_SetUsageValue;
    extern PACKAGE THidP_SetScaledUsageValue
    HidP_SetScaledUsageValue;
    extern PACKAGE THidP_SetUsageValueArray
    HidP_SetUsageValueArray;
    extern PACKAGE THidP_UsageListDifference
    HidP_UsageListDifference;
    extern PACKAGE THidP_TranslateUsagesToI8042ScanCodes
    HidP_TranslateUsagesToI8042ScanCodes;
#define HidModuleName "HID.dll"

    extern PACKAGE int
    __fastcall HidP_GetButtonCaps_(unsigned ReportType, PHIDPButtonCaps ButtonCaps, Word &ButtonCapsLength,
                                   void *PreparsedData);

    extern PACKAGE int
    __fastcall HidP_GetValueCaps_(unsigned ReportType, PHIDPValueCaps ValueCaps, Word &ValueCapsLength,
                                  void *PreparsedData);
